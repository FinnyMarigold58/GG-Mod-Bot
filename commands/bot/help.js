...
console.log(givencommand)
      const commandHelpEmbed = new Discord.MessageEmbed()
        ...
        commandHelpEmbed.addField("Required Permissions:", `${givencommand.userPermissions.join(", ")}`)
    ...
    const embed = new Discord.MessageEmbed()
      ...
      .setColor('#7289da')
      .setThumbnail(client.user.displayAvatarURL())
      .setDescription(`GG's mod bot is a moderation bot made by Finny#6420 for Sponged#2532. This bot is usually used by only a discord server's moderation staff. \n\n**__Important Links__**\n[Support Server](https://discord.gg/9GzsJgAFGf)\n\n**__Commands:__**\n\nIf you'd like more detailed information about a command, run \`${process.env.PREFIX}help [command name]\`.\n\nHere is a full list of all commands that this bot has:`)
